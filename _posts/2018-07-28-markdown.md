...
<p>**Given**: A collection of k (k≤100) DNA strings of length at most 1 kbp each in FASTA format.\n <br>
...
<code style="color:blue;">>Rosalind_1\n</code><br>
<code style="color:blue;">GATTACA\n</code><br>
<code style="color:blue;">>Rosalind_2\n</code><br>
<code style="color:blue;">TAGACCA\n</code><br>
<code style="color:blue;">>Rosalind_3\n</code><br>
<code style="color:blue;">ATACA\n</code><br>

Sample Output\n<br></p>

<code style="color:blue;">AC\n</code><br>
...
<code style="color:blue;"><strong>READ</strong> fasta file and store the sequences in a list\n</code>
<code style="color:blue;"><strong>SORT</strong> the sequences\n</code>
<code style="color:blue;"><strong>SEPARATE</strong> the shortest to the rest of sequences\n</code>
<code style="color:blue;"><strong>CREATE</strong> an empty motif\n</code>
<br>\n
<code style="color:blue;"><strong>FOR EACH</strong> nucleotide in shortest sequence\n</code>
<code style="color:blue;">    <strong>FOR EACH</strong> subsequence starting at diferent nucleotide\n</code>
<code style="color:blue;">        <strong>CREATE</strong> subsequence\n</code>
<code style="color:blue;">        <strong>FOR EACH</strong> of the longer sequences\n</code>
<code style="color:blue;">            <strong>IF</strong> subsequence is present in all sequences\n</code>
<code style="color:blue;">        <strong>IF</strong> subsequence is larger than previous one\n</code>
<code style="color:blue;">            <strong>UPDATE</strong> subsequence\n</code>
