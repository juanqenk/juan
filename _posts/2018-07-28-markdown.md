...
<code style="color:blue;">>Rosalind_1</code>    
<code style="color:blue;">GATTACA</code>   
<code style="color:blue;">>Rosalind_2</code>    
<code style="color:blue;">TAGACCA</code>    
<code style="color:blue;">>Rosalind_3</code>    
<code style="color:blue;">ATACA</code>

Sample Output

<code style="color:blue;">AC</code>
...
<code style="color:blue;">**READ** fasta file and store the sequences in a list</code>      
<code style="color:blue;">**SORT** the sequences</code>        
<code style="color:blue;">**SEPARATE** the shortest to the rest of sequences</code>        
<code style="color:blue;">**CREATE** an empty motif</code>    

<code style="color:blue;">**FOR EACH** nucleotide in shortest sequence</code>      
<code style="color:blue;">    **FOR EACH** subsequence starting at diferent nucleotide</code>    
<code style="color:blue;">        **CREATE** subsequence</code>    
<code style="color:blue;">        **FOR EACH** of the longer sequences</code>    
<code style="color:blue;">            **IF** subsequence is present in all sequences</code>    
<code style="color:blue;">        **IF** subsequence is larger than previous one</code>    
<code style="color:blue;">            **UPDATE** subsequence</code>
